...
<div class="content" tabindex="-1">
    <div class="container-md py-sm-3 usrReg">
        <div class="container-info row-box row mb-0 g-0">
            ...
            <div class="modal-body py-3">
                <div class="container-md text-center usrReg">
                    <form id="frm">
                        <div class="d-md-flex justify-content-md-center position-relative photo">
                            <img id="profileImg" src="/images/image.png" class="img-profile">
                            <label for="imgFile" class="align-self-end psitAb">
