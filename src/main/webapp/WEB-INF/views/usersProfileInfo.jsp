...
<div class="content">
    <form id="frm">
        <div class="container pt-3">
            <h2>직원 프로필관리</h2>
            <div class="input-group pb-3 justify-content-lg-end">
                ...
                <button type="button" id="find" class="btn btn-secondary"><span class="blind">검색</span>
                </button>
            </div>
            <div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-5">
                            <colgroup>
                                ...
                                <col style="width: 10%;"><%-- 소속 --%>
                                <col style="width: 10%;"><%-- 발주처 --%>
                                <col style="width: auto;"><%-- 사업명 --%>
                                <col style="width: 15%;"><%-- 사업기간 --%>
                                <col style="width: 10%;"><%-- 수행경력 --%>
                                <col style="width: 5%;"><%-- 자격증여부 --%>
                            <colgroup>
                            <thead>
                            <tr>
                                <th scope="col">NO</th>
