...
<div class="content" tabindex="-1">
    <div class="container-md" style="height: 100%">
        <div class="container-info row-box row mb-0 g-0">
            <h2 class="header" style="height: 10%">직원 기술
            ...
            <form id="frm" style="height: 90%">
                <div class="container-md text-center">
                            ...
                            <c:choose>
                                <c:when test="${flag ne 1}">
                                    <div class="col-sm-3 common-box input-box mb-1">
                                        <input type="hidden" name="skillList[${status.index}]skill_id"
                                               value="${skill.skill_id}"/>
                                        <input type="text" class="text-center"
                                               name="skillList[${status.index}]skill_nm"
                                               value="${skill.skill_nm}" readonly/>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="col-sm-3 common-box input-box sort mb-1"
                                         onclick="removeEl(this)">
                                        <input type="hidden" class="idx"
                                               name="skillList[${status.index}].skill_id"
                                               value="${skill.skill_id}"/>
                                        <input class="over text-center" type="text"
                                               name="skillList[${status.index}].skill_nm"
                                               value="${skill.skill_nm}" readonly/>
                    ...
                    <c:if test="${flag eq 1}">
                        <div id="addSkill" class="col-sm p-3">
                            <input type="text" name="newSkill" class="search-input px-md-3" maxlength="20">
                            <button type="button" class="btn btn-secondary add_field"><span>추가</span></button>
                        </div>
                    </c:if>
                </div>
            </form>
